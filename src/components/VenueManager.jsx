    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-border px-4 py-3">
          ...
          <button onClick={onClose} className="flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground hover:bg-muted" aria-label="閉じる">
            <X className="h-4 w-4" />
          </button>
        </div>
            ...
            {venues.map((venue) => {
              ...
              return (
                <div key={venue.id} className="flex min-w-0 items-center gap-2 rounded-md border border-border bg-card px-3 py-2">
                  ...
                  <button onClick={() => setEditingVenue(venue)} className="flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground hover:bg-muted hover:text-foreground sm:h-7 sm:w-7" aria-label={`${venue.name}を編集`}>
                    <Pencil className="h-3.5 w-3.5" />
                  </button>
                  <button onClick={() => setConfirmDelete(venue)} className="flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground hover:bg-destructive/10 hover:text-destructive sm:h-7 sm:w-7" aria-label={`${venue.name}を削除`}>
